...
if (class_exists('DPSI_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class DPSI_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://DPSI.php.net/package/PHP_CodeSniffer
 */
class DPSI_Sniffs_Commenting_ClassCommentSniff extends DPSI_Sniffs_Commenting_FileCommentSniff
{
