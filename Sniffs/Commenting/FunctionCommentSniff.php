 ...
 * @link      http://DPSI.php.net/package/PHP_CodeSniffer
 */
class DPSI_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processParams($commentStart)
    {
        ...
        if (empty($params) === false) {
            ...
            if ($params[0]->getOrder() !== 2) {
                $error    = 'Les paramètres doivent être tout de suite après le commentaire';
            ...
            foreach ($params as $param) {
                ...
                if (isset($paramComment[0]) && $paramComment[0] != strtoupper($paramComment[0])) {
